...
gameScene.preload = function(){
    ...
    this.load.image('lights', 'assets/shadow.png');
...
gameScene.create = function() {
    ...
    //lights
    let lights = this.add.sprite(0, 0, 'lights');
    lights.depth = 2;
    lights.setOrigin(0,0);

    //the player
    this.player = this.add.sprite(40, 300, 'player');
    this.player.depth = 1;
    this.player.setScale(0.5);

    //goal
    this.goal = this.add.sprite(this.sys.game.config.width - 80, 300, 'goal');
